...
public class SoundSource : MonoBehaviour
{
    ...
    {
        if (_primaryAudioSource.clip != null)
        {
            Play();
        }
        else if (_clips != null && _clips.Length > 0)
        {
            PlayRandom();
        }
    }
    ...
    [Button(ButtonSizes.Medium), EnableIf("@UnityEngine.Application.isPlaying && IsPlaying")]
